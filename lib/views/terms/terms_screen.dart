      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              const Text(
                'Ao participar do evento “Shell ao KM”, o utilizador concorda em cumprir as regras estabelecidas no Regulamento Oficial do Rally Paper, incluindo, mas não se limitando a:\n\n'
